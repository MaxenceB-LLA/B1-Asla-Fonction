<?php
	...
	function estUnPetitPrix( $produit , $petitPrix ){
		...
		// Votre code ici
		$verification = $prixUnit * $promo ;
		$verification = $prixUnit - $verification;
		if($verification < $petitPrix){
			return TRUE ;
		}
		else{
			return FALSE ;
	...
	function calculerPrixPromo( $produit ){
		...
		// Votre code ici
		$promoAppliquer = $prixUnit * $promo ;
		$promoAppliquer = $prixUnit - $promoAppliquer ;
		if($promoAppliquer < $prixUnit){
			return TRUE ;
		}
		else{
			return FALSE ;
